			...
			<div class="c3_b1_left">
				<dl>
					<dd>
						<h1>文学类</h1>
						<p>
							<a href="list.jsp">文学1</a> <a href="list.jsp">文学2</a> <a
								href="list.jsp">文学3</a> <a href="list.jsp">文学4</a>
						</p>
					</dd>
					<dd>
						<h1>教育类</h1>
						<p>
							<a href="list.jsp">教育1</a> <a href="list.jsp">教育2</a>
						</p>
					</dd>
					<dd>
						<h1>计算机</h1>
						<p>
							<a href="list.jsp">计算机1</a> <a href="list.jsp">计算机2</a> <a
								href="list.jsp">计算机3</a>
						</p>
					</dd>
					<dd>
						<h1>儿童类</h1>
						<p>
							<a href="list.jsp">图书1</a> <a href="list.jsp">图书2</a> <a
								href="list.jsp">图书3</a>
						</p>
					</dd>
					<dd>
					...
					<dd>
						<h1>工具书</h1>
						<p>
							<a href="list.jsp">工具书1</a> <a href="list.jsp">工具书2</a>
						</p>
					</dd>
					<dd class="last">
						<h1>期刊</h1>
						<p>
							<a href="list.jsp">期刊1</a> <a href="list.jsp">期刊2</a> <a
								href="list.jsp">期刊3</a>
						</p>
					</dd>
				</dl>
