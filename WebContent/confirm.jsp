...
<body>
    ...
    <div class="content">
	    	<div class="contentCenter">
	    		...
	    		<span>
	    		<a href="confirmList.jsp"><button>删除该订单</button></a>   
	    		...
	    		<div class="bigDiv">
	    			<table border="1px solid red" >
	    				...
	    				<tr>
	    					<td width="100px" ><img src="images/viewBook.png" width="100px" height="100px"></td>
	    					<td width="300px" align="center" >JAVAEE</td>
	    					<td width="600px" align="center" >￥1000元</td>
			...
			<div class="pop_con">
				...
				<div class="btn_bar">
					<a href="javascript:void(0)" id="submitAdd" class="btn_red"
						...
						href="shopCart.jsp" id="cancelAdd" class="btn">返回购物车查看商品</a>
				</div>
			</div>
		</div>
	</div>
